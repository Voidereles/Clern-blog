...
// if (windowWidth > 1200 && windowWidth < 1921 && windowWidth > window.innerHeight) {
...
let owlVideo = $('owl-video2');

// owlVideo.addEventListener("play", function () {
//     $(".owl-video__img-container").toggleClass('owl-video__img-container--active');
// });
